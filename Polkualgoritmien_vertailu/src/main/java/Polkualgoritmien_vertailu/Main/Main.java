...
public class Main {
    ...
    /**
     * mainissa voi testata ohjelmaa. ylläolevaa testi-taulukkoa on helppo muokata,
     * jos haluaa kokeilla erilaisia. '#' on seinä, pidä reunus niitä täynnä. Ohjelman
     * on valmiina tarkoitus täyttää ne automaattisesti, joten tarkistusta taulukon
     * ylittämiselle tai alittamiselle ei ole tehty. Toistaiseksi algoritmi kulkee
     * vain '.'-merkin kohdilla, mutta myöhemmin tarkoitus tulla muitakin.
     * 
    ...
    public static void main(String[] args) {
        ...
        Solmu[][] ratkaisu =  dijkstra.ratkaise(testi, x, y);
